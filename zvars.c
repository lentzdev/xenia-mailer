...
#endif
#if ZDEBUG
char *hdrtypes[] = { "", "HEX ", "BIN ", "BIN32 " };
char *endtypes[] = { "ZCRCE", "ZCRCG", "ZCRCQ", "ZCRCW" };
#endif
char *frametypes[] = {
#if ZCOMP
	"Bad Special Delivery sequence",
#endif
	"ZCRCW",
	"Aborted by operator",
	"Carrier lost",
	"BDD TIMEOUT (brain dead/damaged)",
	"TIMEOUT",
